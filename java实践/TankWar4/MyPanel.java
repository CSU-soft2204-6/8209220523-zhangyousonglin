...
public class MyPanel extends JPanel implements KeyListener, Runnable {
	...
	public MyPanel(String key) {
		nodes = Recorder_.getNodesAndEnermyNum();

		Recorder_.setEnemyTank(enemyTanks);
		//生成
		...
		switch (key) {
			case "1":
				for (int i = 0; i < EnemyTankSize; i++) {
					...
					Recorder_.setAllEnermyTankNums(0);
			...
			case "2":
				...
				break;
			default:
				System.out.println("你的输入有误,请输入1或2");
				System.out.println("1：开始新一局 2：继续上一局");
	...
	public void showInfo(Graphics g) {
		...
		g.drawString(Recorder_.getAllEnermyTankNums() + "", 1080, 100);
